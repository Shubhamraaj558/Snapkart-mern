    ...
    <div className="min-h-[calc(100vh-120px)] bg-slate-950 px-2 sm:px-4 py-4">
      ...
      <div className="md:hidden flex items-center justify-between bg-slate-900 border border-white/10 px-4 py-3 rounded-2xl mb-4 shadow-lg">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 px-3 py-2 rounded-xl text-sm font-semibold"
        >
          <FaBars size={16} />
          <span>Menu</span>
        </button>
      ...
      {mobileSidebarOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden bg-black/70 backdrop-blur-sm">
          <div className="w-[300px] max-w-full h-full bg-slate-950 border-r border-white/10 overflow-y-auto shadow-2xl">
            <SidebarContent />
          </div>
