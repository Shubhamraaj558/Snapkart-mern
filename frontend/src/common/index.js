const backendDomin = "https://snapkart-mern.onrender.com"
...
const SummaryApi = {
    ...
    addWishlist: {
        url: `${backendDomin}/api/add-wishlist`,
        method: "post"
    },
    getWishlist: {
        url: `${backendDomin}/api/get-wishlist`,
        method: "get"
    },
    deleteWishlist: {
    ...
    updateProfilePic: {
        url: `${backendDomin}/api/update-profile-pic`,
        method: "post"
    }
}
